...
//   ? Acc['length'] | NumberRange<Start, End, [...Acc, Acc['length']]>
...
type test = Utils<10> // 0 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9 | 1 | 10
type test2 = Utils<5> // 0 | 2 | 3 | 4 | 5 | 1

type test3 = Exclude<Utils<10>, Utils<5>> // 6 | 7 | 8 | 9 | 10
