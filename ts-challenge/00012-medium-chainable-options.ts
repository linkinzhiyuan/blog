...
//   // option: <K extends keyof T>(key: K, value: T[K]) => Chainable<Omit<T, K> & Record<K, T[K]>>
//   option: <K extends keyof T, V>(key: K extends keyof T ? never : K, value: V) => Chainable<Omit<T, K> & Record<K, V>>
//   get(): () => T
// }
